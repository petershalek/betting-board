...
class BetsControllerTest < ActionController::TestCase
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post :create, bet: { actual_result_date: @bet.actual_result_date, estimated_result_date: @bet.estimated_result_date, metric: @bet.metric, name: @bet.name, result: @bet.result }
    end
  ...
  test "should update bet" do
    patch :update, id: @bet, bet: { actual_result_date: @bet.actual_result_date, estimated_result_date: @bet.estimated_result_date, metric: @bet.metric, name: @bet.name, result: @bet.result }
    assert_redirected_to bet_path(assigns(:bet))
  end
